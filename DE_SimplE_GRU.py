...
class DE_SimplE_GRU(nn.Module):
    def __init__(self,dataset, params, hidden_size=100, pretrained_vocab=None,
        ...
        self.rel_emb_f = nn.Embedding(dataset.numRel(), params.s_emb_dim+params.t_emb_dim).cuda()
        self.rel_emb_i = nn.Embedding(dataset.numRel(), params.s_emb_dim+params.t_emb_dim).cuda()
